...
{
    public class ExpertIdeaController : Controller
    {
        ...
        [HttpGet]
        public ActionResult ExDetail(string news)
        {
            if (news.Contains("^"))
            {
            ...
            if(cm.data.meta.image.Contains("Soikeoplus")){
                cm.data.meta.image = "/Upload/soikeo.jpg";
            }
            ...
            return PartialView("ExDetail", cm);
        }
    }
}